  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center p-6 md:p-24">
      <div className="w-full max-w-md p-8 border rounded-xl shadow-sm bg-white">
        <h1 className="text-2xl font-bold mb-2 text-center text-gray-900">Register</h1>
        <p className="text-sm text-center text-gray-500 mb-8">Buat akun baru untuk memulai</p>
        ...
        <div className="mt-6 pt-6 border-t border-gray-100">
          <p className="text-center text-sm text-gray-600">
            Sudah punya akun? <Link href="/auth/login" className="text-blue-600 font-medium hover:underline">Login di sini</Link>
          </p>
